...
export default function ActivitiesPage() {
  const [images, setImages] = useState({
    "blood-donation.jpg": "/placeholder.svg",
    "food-truck.jpg": "/placeholder.svg",
        ...
        <div className="pt-16 pb-32">
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
              ...
              <div className="md:col-span-7 relative aspect-[16/9] rounded-lg overflow-hidden">
                <Image src={images["blood-donation.jpg"]} alt="Blood Donation" fill className="object-cover" />
              </div>
            </div>
          </section>
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
              <div className="md:col-span-7 relative aspect-[16/9] rounded-lg overflow-hidden order-2 md:order-1">
                <Image src={images["food-truck.jpg"]} alt="Food Truck" fill className="object-cover" />
              </div>
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
              ...
              <div className="md:col-span-7 relative aspect-[16/9] rounded-lg overflow-hidden">
                <Image src={images["cultural-events.jpg"]} alt="Cultural Events" fill className="object-cover" />
              </div>
            </div>
          </section>
